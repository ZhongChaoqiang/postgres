-- 测试 vector_distance 参数

-- 测试 vector_l2_ops 值（默认值）
CREATE TABLE test_dist_l2 (id int, content text) WITH (vector_distance = 'vector_l2_ops');

-- 测试 vector_ip_ops 值
CREATE TABLE test_dist_ip (id int, content text) WITH (vector_distance = 'vector_ip_ops');

-- 测试 vector_cosine_ops 值
CREATE TABLE test_dist_cosine (id int, content text) WITH (vector_distance = 'vector_cosine_ops');
