...
PG_CMDTAG(CMDTAG_CREATE_EMBEDDINGS, "CREATE EMBEDDINGS", false, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_TIMESERIES_VECTOR_TABLE, "CREATE TIMESERIES VECTOR TABLE", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_EMBEDDINGS, "DROP EMBEDDINGS", false, false, false)
