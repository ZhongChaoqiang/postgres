...
PG_KEYWORD("carry", CARRY, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("time_bucket", TIME_BUCKET, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("timeseries", TIMESERIES, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("vectorize", VECTORIZE, UNRESERVED_KEYWORD, BARE_LABEL)
