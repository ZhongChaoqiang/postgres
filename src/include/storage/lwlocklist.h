...
PG_LWLOCK(24, AsyncPredict)
PG_LWLOCK(25, SyncScan)
PG_LWLOCK(26, RelationMapping)
/* 27 was NotifySLRULock */
PG_LWLOCK(28, NotifyQueue)
PG_LWLOCK(29, SerializableXactHash)
PG_LWLOCK(30, SerializableFinishedList)
PG_LWLOCK(31, SerializablePredicateList)
/* 32 was SerialSLRULock */
PG_LWLOCK(33, SyncRep)
PG_LWLOCK(34, BackgroundWorker)
PG_LWLOCK(35, DynamicSharedMemoryControl)
PG_LWLOCK(36, AutoFile)
PG_LWLOCK(37, ReplicationSlotAllocation)
PG_LWLOCK(38, ReplicationSlotControl)
/* 39 was CommitTsSLRULock */
PG_LWLOCK(40, CommitTs)
PG_LWLOCK(41, ReplicationOrigin)
PG_LWLOCK(42, MultiXactTruncation)
/* 43 was OldSnapshotTimeMapLock */
PG_LWLOCK(44, LogicalRepWorker)
PG_LWLOCK(45, XactTruncation)
/* 46 was XactTruncationLock until removal of BackendRandomLock */
PG_LWLOCK(47, WrapLimitsVacuum)
PG_LWLOCK(48, NotifyQueueTail)
PG_LWLOCK(49, WaitEventCustom)
PG_LWLOCK(50, WALSummarizer)
PG_LWLOCK(51, DSMRegistry)
PG_LWLOCK(52, InjectionPoint)
PG_LWLOCK(53, SerialControl)
PG_LWLOCK(54, AioWorkerSubmissionQueue)
PG_LWLOCK(55, WaitLSN)
