 ...
 */
	...
	{"Client", "WaitForWalFlush", "Waiting for WAL flush to reach a target LSN on a primary"},
	{"Client", "WaitForWalReplay", "Waiting for WAL replay to reach a target LSN on a standby"},
	...
	{"LWLock", "AsyncPredict", "Waiting to read or update async prediction worker state"},
	...
	{"LWLock", "WaitLSN", "Waiting to read or update shared Wait-for-LSN state"},
