...
struct config_generic ConfigureNames[] =
{
	...
	{
		.name = "async_predict_batch_size",
		.context = PGC_SIGHUP,
		.group = CUSTOM_OPTIONS,
		/* translator: GUC parameter "async_predict_batch_size" short description */
		.short_desc = gettext_noop("Maximum number of rows to process per scan for async prediction."),
		.vartype = PGC_INT,
		._int = {
			.variable = &async_predict_batch_size,
			.boot_val = 100,
			.min = 1,
			.max = 10000,
		},
	...
	{
		.name = "async_predict_enabled",
		.context = PGC_SIGHUP,
		.group = CUSTOM_OPTIONS,
		/* translator: GUC parameter "async_predict_enabled" short description */
		.short_desc = gettext_noop("Enables async prediction worker."),
		.vartype = PGC_BOOL,
		._bool = {
			.variable = &async_predict_enabled,
			.boot_val = true,
		},
	},

	{
		.name = "async_predict_naptime",
		.context = PGC_SIGHUP,
		.group = CUSTOM_OPTIONS,
		/* translator: GUC parameter "async_predict_naptime" short description */
		.short_desc = gettext_noop("Time to sleep between async prediction runs."),
		.flags = GUC_UNIT_S,
		.vartype = PGC_INT,
		._int = {
			.variable = &async_predict_naptime,
			.boot_val = 60,
			.min = 1,
			.max = INT_MAX / 1000,
		},
	...
	{
		.name = "async_predict_workers",
		.context = PGC_POSTMASTER,
		.group = CUSTOM_OPTIONS,
		/* translator: GUC parameter "async_predict_workers" short description */
		.short_desc = gettext_noop("Number of async prediction worker processes."),
		.vartype = PGC_INT,
		._int = {
			.variable = &async_predict_workers,
			.boot_val = 2,
			.min = 0,
			.max = MAX_BACKENDS,
		},
...

	{
		...
		.context = PGC_USERSET,
		.group = COMPAT_OPTIONS_PREVIOUS,
		/* translator: GUC parameter "escape_string_warning" short description */
...

	{
		...
		.context = PGC_SIGHUP,
		.group = RESOURCES_IO,
		/* translator: GUC parameter "io_workers" short description */
